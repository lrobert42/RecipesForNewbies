...
abstract class IngredientsDatabase : RoomDatabase() {
     ...
     */
    abstract val ingredientsDatabaseDao: IngredientsDatabaseDAO

    /**
     * Define a companion object, this allows us to add functions on the IngredientsDatabase class.
     *
     * For example, clients can call `IngredientsDatabase.getInstance(context)` to instantiate
     * a new IngredientsDatabase.
     */
    companion object {
        /**
            ...
            synchronized(this) {
                ...
                if (instance == null) {
                    instance = Room.databaseBuilder(
                        ...
                        .createFromAsset("database/ingredient.db")
