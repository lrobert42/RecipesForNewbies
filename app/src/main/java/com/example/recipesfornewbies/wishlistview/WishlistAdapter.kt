...
class WishlistAdapter : ListAdapter<Recipe, WishlistAdapter.RecipeViewHolder>(DiffCallback) {

    class RecipeViewHolder(private var binding: RecipeCardViewBinding):
        RecyclerView.ViewHolder(binding.root) {

        fun bind(recipe: Recipe) {
//            binding.buttonAddWishlist.isVisible = false
//            binding.buttonDeleteRecipe.isVisible = false
