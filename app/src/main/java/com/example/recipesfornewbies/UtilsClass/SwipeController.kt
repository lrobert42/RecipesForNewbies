...
abstract class SwipeToDeleteCallback(context: Context) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
    ...
    private val deleteIcon = ContextCompat.getDrawable(context, R.drawable.ic_android_primary_24dp)
...
abstract class SwipeToAddToWishList(context: Context) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
    ...
    private val background = ColorDrawable()
    private val backgroundColor = Color.parseColor("#339966")
    private val clearPaint = Paint().apply { xfermode = PorterDuffXfermode(PorterDuff.Mode.CLEAR) }
    ...
    override fun onChildDraw(
        ...
        val wishlistIconLeft = itemView.left + wishlistIconMargin - intrinsicWidth
        val wishlistIconRight = itemView.left + wishlistIconMargin
