...
import com.example.recipesfornewbies.UtilsClass.ExtendedIngredientsConverters

@Database(entities = [WishlistRecipe::class], version = 2, exportSchema = false)
@TypeConverters(ExtendedIngredientsConverters::class)
